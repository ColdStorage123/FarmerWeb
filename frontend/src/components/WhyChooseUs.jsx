...
import CheckCircleOutlineIcon from '@mui/icons-material/CheckCircleOutline'; // Example icon (you can replace it with any other icon)
...
const paperStyle = {
  ...
  height: '100%', // Set a fixed height for equal-sized cards
};
