...
function OrderStatus() {
  ...
  const acceptOrder = (orderId) => {
    // Implement the logic to accept an order
    // You can make a POST request to your API endpoint to accept the order here
  };

  const rejectOrder = (orderId) => {
    // Implement the logic to reject an order
    // You can make a POST request to your API endpoint to reject the order here
  };
